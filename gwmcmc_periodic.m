...
%   'ProgressBar': Show a text progress bar (default=false)
...
if isoctave
    ...
    p.addParameter('StepSize',1.95,@isnumeric); %addParamValue is chose for compatibility with octave. Still Untested.
...
for row=1:Nkeep
    ...
    cur_mean = circ_mean(curm(3, :)*2*pi/(24*60 / p.BinSize));
